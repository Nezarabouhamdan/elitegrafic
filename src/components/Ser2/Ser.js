...
import { Serdesc, Serdetails, Serimg, Serimgm, Sername, Sersdiv, Sersection, Sersicon, Sertop } from './Serstyles';
...
import { Textdiv } from '../Services/Servicesstyles';
import { Decoration, Dtext, Line } from '../Work/workstyles';

const Ser = () => {
    return (
      <Sersection>
      <Textdiv>     Our Services
</Textdiv>
  <Decoration> 
   <Line>   </Line>
...
we have dozens of terms for this basic idea,
 including customer support, customer care,
  client relations, and support service.<br></br>
...
<Serdesc>Mobile application development includes numerous services in different domains and topics. The
services include developing mobile applications, especially for end-user smartphones, tablets, and other
similar devices.</Serdesc>
</Serdetails>
    <Serimg src={graphic}/>
    <Serdetails>
<Sersicon src={img1}></Sersicon>
<Sername>Web Development</Sername>
<Serdesc>Web application development means a whole range of distinct services that include enterprise
and customer research, architecture planning, design , frontend and backend coding, optimization,
maintenance, DevOps, and a lot more.</Serdesc>
</Serdetails>
    </Sertop><Sertop>
<Serimg src={app}/>
<Serdetails>
...
<Serdesc>Graphic design is an interdisciplinary branch of design and of the fine arts.
 Its practice involves creativity, innovation and lateral thinking using manual or digital tools, 
 where it is usual to use text and graphics to communicate visually.</Serdesc>
</Serdetails>
<Serimg src={web}/>
 </Sertop>
    </Sersdiv>
